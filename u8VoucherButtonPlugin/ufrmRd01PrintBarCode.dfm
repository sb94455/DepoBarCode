object frmRd01PrintBarCode: TfrmRd01PrintBarCode
  Left = 679
  Top = 0
  Width = 719
  Height = 576
  Caption = #21040#36135#26465#30721
  Color = clBtnFace
  ...
  object clbr1: TCoolBar
    ...
    object tlb1: TToolBar
      ...
      object btnSelAll1: TToolButton
        Left = 297
        Top = 0
        Action = actSelAll
      end
      object btnSelUnSel2: TToolButton
        Left = 356
        Top = 0
        Action = actUnSelAll
      end
      object btnSelUnSel1: TToolButton
        Left = 415
        Top = 0
        Action = actSelUnSel
      end
  ...
  object pmVouchs: TPopupMenu
    ...
    Top = 144
    object N1: TMenuItem
      Caption = #21024#38500#23545#24212#26465#30721
      OnClick = N1Click
    end
  end
  ...
  object pmQrCode: TPopupMenu
    OnPopup = pmQrCodePopup
    Left = 256
    Top = 472
